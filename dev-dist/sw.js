...
define(['./workbox-b004d73f'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/cdnjs\.cloudflare\.com\//, new workbox.StaleWhileRevalidate({
    "cacheName": "cdn-cache",
    plugins: []
  }), 'GET');
  workbox.registerRoute(/^https:\/\/placehold\.co\//, new workbox.StaleWhileRevalidate({
    "cacheName": "images",
    plugins: []
  }), 'GET');
