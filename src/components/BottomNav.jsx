...
const BottomNav = () => {
  ...
  return (
    <nav className="bottom-nav fixed bottom-0 left-0 right-0 bg-white flex justify-around w-full max-w-[375px] mx-auto z-10 border-t border-brand-subtle md:hidden">
      {navItems.map(item => (
        <button
          key={item.id}
