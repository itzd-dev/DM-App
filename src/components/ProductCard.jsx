...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="border border-brand-subtle rounded-lg overflow-hidden shadow-sm bg-white flex flex-col">
      ...
      <div className="p-3 pt-0">
        <button 
          ...
          className={`w-full text-white text-xs font-semibold py-2 rounded-lg transition ${product.isAvailable ? 'bg-brand-primary hover:bg-opacity-90' : 'bg-gray-400 cursor-not-allowed'}`}>
